...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        """
        if (not isinstance(insect, QueenAnt)) or insect.truequeen == False:
            if insect.is_ant:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while curr_place!= None:
            if curr_place.bees!=[]:
                bee = random_or_none(curr_place.bees)
                if bee.place is not hive:
                    return bee
                else:
                    return None
            else:
...
class ShortThrower(ThrowerAnt):
    """A ThrowerAnt that only throws leaves at Bees at[z] most 3 places away."""
    food_cost = 2
    armor = 1
    name = 'Short'
    max_range = 3
    ...
    def nearest_bee(self,hive):
        ...
        count = 0
        while curr_place!= hive and count < self.max_range:
            if curr_place.bees == []:
                curr_place = curr_place.entrance
                count+=1
            else:
...
# END Problem 13
    ...
    def __init__(self):
        # BEGIN Problem 13
        Ant.__init__(self)
        if not QueenAnt.truequeen:
            self.truequeen = True
            QueenAnt.truequeen = True
        else:
    ...
    def action(self, colony):
        ...
        """
        # BEGIN Problem 13
        def double(doubleant):
            doubleant.damage = 2 * doubleant.damage
            self.listofants.append(doubleant)
        ...
        if self.truequeen == False:
            ...
            while curr_place != None:
                if curr_place.ant != None:
                    if curr_place.ant.container and curr_place.ant.ant and curr_place.ant.ant not in self.listofants:
                        double(curr_place.ant.ant)
                    elif curr_place.ant not in self.listofants:
                        double(curr_place.ant)
